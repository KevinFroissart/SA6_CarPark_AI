...
\begin{center}
\leavevmode
\includegraphics[width=167pt]{class_t_c_p_socket__coll__graph}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em Recieves a message trough the socket. \end{DoxyCompactList}\item 
...
bool {\bfseries Connect} (const std\+::string \&ipaddress, unsigned short port)
\item 
...
int {\bfseries Send} (const char $\ast$data, unsigned int len)
\item 
...
int {\bfseries Receive} (char $\ast$buffer, unsigned int len)
...
\begin{center}
\leavevmode
\includegraphics[width=349pt]{class_t_c_p_socket_ac816c30175550d8d9a14c89c1c5ec8da_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{class_t_c_p_socket_a8341c9364e71e992aa61534dbf88a2a2}\label{class_t_c_p_socket_a8341c9364e71e992aa61534dbf88a2a2}} 
...
\item 
S\+A6/headers/T\+C\+P\+Socket.\+hpp\item 
Server/headers/T\+C\+P\+Socket.\+h\item 
S\+A6/src/T\+C\+P\+Socket.\+cpp\end{DoxyCompactItemize}
