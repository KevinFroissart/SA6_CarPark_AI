...
\index{Parking@{Parking}!````~Parking@{$\sim$Parking}}
\index{````~Parking@{$\sim$Parking}!Parking@{Parking}}
\doxysubsubsection{\texorpdfstring{$\sim$Parking()}{~Parking()}}
{\footnotesize\ttfamily Parking\+::$\sim$\+Parking (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})}



Destroy the \mbox{\hyperlink{class_parking}{Parking}}\+:\+: \mbox{\hyperlink{class_parking}{Parking}} object. 
