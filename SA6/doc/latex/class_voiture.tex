...
\begin{DoxyCompactList}\small\item\em Method used to connect the car with a specific \mbox{\hyperlink{class_parking}{Parking}} using sockets. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{class_voiture_a0d7ccac52a67547de28bc40763804315}{get\+ID}} ()
\begin{DoxyCompactList}\small\item\em methoid that returns the ID of the \mbox{\hyperlink{class_voiture}{Voiture}} \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\index{Voiture@{Voiture}!calcul\_prix@{calcul\_prix}}
\index{calcul\_prix@{calcul\_prix}!Voiture@{Voiture}}
