...
\index{Tool\+Box@{Tool\+Box}!C\+S\+V\+Reader@{C\+S\+V\+Reader}}
\index{C\+S\+V\+Reader@{C\+S\+V\+Reader}!Tool\+Box@{Tool\+Box}}
...
\index{Tool\+Box@{Tool\+Box}!C\+S\+V\+Writer@{C\+S\+V\+Writer}}
\index{C\+S\+V\+Writer@{C\+S\+V\+Writer}!Tool\+Box@{Tool\+Box}}
\subsubsection{\texorpdfstring{C\+S\+V\+Writer()}{CSVWriter()}}
...
\index{Tool\+Box@{Tool\+Box}!float\+Tab\+To\+String@{float\+Tab\+To\+String}}
\index{float\+Tab\+To\+String@{float\+Tab\+To\+String}!Tool\+Box@{Tool\+Box}}
